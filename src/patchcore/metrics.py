...
def cal_pro_metric_new(labeled_imgs, score_imgs, fpr_thresh=0.3, max_steps=200, class_name=None):


    labeled_imgs = np.stack(labeled_imgs)
    score_imgs = np.stack(score_imgs)
